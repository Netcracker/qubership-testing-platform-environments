...
import org.qubership.atp.environments.service.rest.server.ToolController;
...
@PactUrl(urls = {"file:./src/test/resources/pacts/atp-orchestrator-atp-environments.json"})
...
@Slf4j
@Isolated
public class EnvironmentsAndOrchestratorContractTest {
    ...
    public void beforeAll() throws Exception {
        log.info("EnvironmentsAndOrchContractTest tests started");
