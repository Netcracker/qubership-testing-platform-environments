...
public class LazyEnvironmentProjectionTest {

    LazyEnvironmentProjection lazyEnvironmentProjection;
    ...
    @Test
    public void testMap_LazyEnvironmentProjection_gotProjection() {
        ...
        when(systemRepository.getAllShortByParentId(environment.getId())).thenReturn(systems);
        ...
        Environment resultEnvironment = lazyEnvironmentProjection.create(environment.getId(),
