...
public class LazyProjectProjectionTest {
    LazyProjectProjection lazyProjectProjection;
    ...
    public void setUp() {
        ...
        lazyProjectProjection = new LazyProjectProjection(repo);
        environmentRepository = mock(EnvironmentRepositoryImpl.class);
    }

    @Test
    public void testCreateWithDescription_LazyProjectProjection_gotProjection() {
        ...
        Project resultProject = lazyProjectProjection.create(project.getId(),
