...
public class LazySystemProjectionTest {
    LazySystemProjection lazySystemProjection;
    ...
    public void testCreate_LazySystemProjection_gotProjection() {
        ...
        when(connectionRepository.getAllShortByParentId(system.getId())).thenReturn(connections);
        System resultSystem = lazySystemProjection.create(system.getId(),
                system.getName(),
