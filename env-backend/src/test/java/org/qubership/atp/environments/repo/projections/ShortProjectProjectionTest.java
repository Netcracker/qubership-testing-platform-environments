...
public class ShortProjectProjectionTest extends AbstractProjectionTest{

    ShortProjectProjection shortProjectProjection;
    ...
    @Test
    public void testCreateWithDescription_ShortProjectProjection_gotProjection() {
