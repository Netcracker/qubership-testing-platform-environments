...
public class ShortSystemProjectionTest extends AbstractProjectionTest {

    ShortSystemProjection shortSystemProjection;
    ...
    public void setUp() {
        ...
        shortSystemProjection = new ShortSystemProjection(systemRepository);
    }

    @Test
    public void testCreate_ShortSystemProjection_gotProjection() {
        ...
        System resultSystem = shortSystemProjection.create(system.getId(),
                system.getName(),
    ...
    @Test
    public void testMap_ShortSystemProjection_gotSystem() {
        System system = EntitiesGenerator.generateSystem("System");
        ...
        system.setEnvironments(Collections.singletonList(EntitiesGenerator.generateEnvironment("Environment")));
        system.setConnections(connections);
