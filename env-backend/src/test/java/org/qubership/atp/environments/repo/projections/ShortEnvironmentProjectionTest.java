...
public class ShortEnvironmentProjectionTest extends AbstractProjectionTest{

    ShortEnvironmentProjection shortEnvironmentProjection;
    ...
    @Test
    public void testCreate_ShortEnvironmentProjection_gotProjection() {
        ...
        Environment resultEnvironment = shortEnvironmentProjection.create(environment.getId(),
                environment.getName(), environment.getGraylogName(), environment.getDescription(), environment.getSsmSolutionAlias(),
                environment.getSsmInstanceAlias(), environment.getConsulEgressConfigPath(), new Timestamp(0L),
    ...
    @Test
    public void testMap_ShortEnvironmentProjection_gotEnvironment() {
        Environment environment = EntitiesGenerator.generateEnvironment("Environment");
        List<System> systems = Collections.singletonList(EntitiesGenerator.generateSystem("System"));
        environment.setCreated(0L);
