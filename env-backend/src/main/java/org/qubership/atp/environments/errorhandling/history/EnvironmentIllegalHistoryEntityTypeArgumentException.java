...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "ENV-3002")
public class EnvironmentIllegalHistoryEntityTypeArgumentException extends AtpEnvironmentException {
