...
public interface VersionHistoryService<D,S> {

    List<CompareEntityResponseDtoGenerated> getEntitiesByVersion(UUID id, List<String> versions);

    HistoryItemTypeDtoGenerated getItemType();
