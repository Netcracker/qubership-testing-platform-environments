...
package org.qubership.atp.environments.db.changes.v2;
...
public class ServiceEntitiesMigrationCustomChange implements CustomTaskChange {
    ...
    private static final UUID SERVICE_ENTITIES_ID = UUID.fromString("c420cdf9-ce1f-4eff-a697-dcad6fe5f04b");
    ...
    public void execute(Database database) {
        ...
        UsersService usersService = BeanAwareSpringLiquibaseConfiguration.getBean(UsersService.class);
