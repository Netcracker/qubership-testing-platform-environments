...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "ENV-1001")
public class EnvironmentIllegalConnectionTypeException extends AtpEnvironmentException {
