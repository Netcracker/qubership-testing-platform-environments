...
@Service
@Slf4j
public class CommitEnvironmentServiceImpl implements CommitEntityService<Environment> {
    ...
    public void commit(@Nonnull Environment environment) {
        javersService.commit(new EnvironmentJ(environment));
    }

    @Override
    public void delete(@Nonnull UUID id) {
        javersService.commitShallowDeleteById(InstanceIdDTO.instanceId(id, EnvironmentJ.class));
    }
